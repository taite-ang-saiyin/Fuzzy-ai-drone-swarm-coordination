...
def update(frame):
    ...
    for i in range(NUM_DRONES):
        ...
        stuck = False
        all_very_close = all(dist < 0.5 for dist in sensor_dists)
        fuzzy_out = fuzzy.get_advanced_avoidance_policy(sensor_dists, None, None, stuck, all_very_close)
        ...
        angle = base_angle + fuzzy_out['yaw_rate'] * 0.12
        ...
        speed = 0.22 + fuzzy_out['thrust_adjustment'] * 0.12
